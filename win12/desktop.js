...
let nts = {
    ...
    'about-copilot': {
        cnt: `
            ...
            也请适当使用，不要谈论敏感、违规话题，<br>请有身为一个人类最基本的道德底线。<br></p>`,
        btn: [
            { type: 'main', text: '确定', js: 'closenotice();' },
        ]
    },
    'feedback-copilot': {
        cnt: `<p class="tit"> Windows 12 Copilot</p>
        <p></p>
        <list class="new">
        </list>
            `,
...
let apps = {
    ...
    box-shadow: 0 1px 2px var(--s3d);
            ...
            </div><p class="info">250 GB 可用, 共 2 TB</p></div></a><a class="a item act" ondblclick="apps.explorer.goto('D:')" ontouchend="apps.explorer.goto('D:')"
            ...
            </div><p class="info">3.2 TB 可用, 共 4 TB</p></div></a></div>`;
...
let copilot = {
    ...
    init: () => {
        $('#copilot>.chat').html('');
        copilot.send(`请使用中文对话，请使用中文对话，请使用中文对话！。你一个是ai助手，名叫AI Copilot。
            ...
            if (r.length) {
                for (const i of r) {
                    if (/{openapp .+?}/.test(i)) {
                        ...
                        shownotice('feedback');
                        rt = rt.replace(i, `<div class="action"><p class="tit"></p><p class="detail">关于 Windows 12 网页版</p></div>`)
                    } else if (/{feedback copilot}/.test(i)) {
                        shownotice('feedback-copilot');
                        rt = rt.replace(i, `<div class="action"><p class="tit"></p><p class="detail">关于 Windows 12 Copilot</p></div>`)
